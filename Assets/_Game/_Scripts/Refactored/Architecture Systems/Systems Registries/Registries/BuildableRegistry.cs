...
public class BuildableRegistry
{
    ...
    public void EnterBuildMode() => _buildableObjects.ForEach(pausableObject => pausableObject.BuildMode_Enable());
    public void ExitBuildMode() => _buildableObjects.ForEach(pausableObject => pausableObject.BuildMode_Disable());
}